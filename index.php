		...
		<div class="container-login100">
			<div class="wrap-login100">
				<div class="login100-pic js-tilt" data-tilt>
					<img src="images/Logo PBB.png" alt="IMG">
				</div>
				...
				<form class="login100-form validate-form" action="index.php" method="post">
					...
					<div class="wrap-input100 validate-input" data-validate = "Anda tidak memasukan jari-jari">
				...
				$jari=$_POST['jari'];
				$phi=3.14;
				$luas_lingkaran = $phi * $jari * $jari; // menghitung luas segitiga
